...
export const layoutMetadata: LayoutMetadata[] = [
  // Top 5 (Essential)
  {
    ...
    description: 'Fixed header with left sidebar navigation and scrollable main content. The default for most SaaS and admin apps.',
    tier: 'essential',
    route: '/layouts/classic-app-shell',
    useCases: ['SaaS applications', 'Admin dashboards', 'Content management systems'],
    headerPattern: 'app-only',
    features: ['Fixed app header', 'Left sidebar navigation', 'Scrollable main content'],
  },
  {
    id: 'dashboard-grid',
    name: 'Dashboard Grid',
    description: 'Card-based layout showing KPIs, charts, and tables with clear visual hierarchy.',
    tier: 'essential',
    route: '/layouts/dashboard-grid',
    useCases: ['Analytics dashboards', 'Executive summaries', 'Data visualization'],
    headerPattern: 'app-only',
  ...
  },
  {
    ...
    description: 'Page-specific header with actions and status that stays visible while scrolling a long record.',
    tier: 'essential',
  ...
  },
  {
    id: 'master-detail',
    name: 'Master–Detail',
    description: 'A list or table on the left with a detail panel on the right for fast item inspection.',
    tier: 'essential',
  ...
  },
  {
    ...
    description: 'Step-based or sectioned form layout with clear progress and persistent actions.',
    tier: 'essential',
  ...
  // Top 10 (Modern Set) - Adds 5 more
  {
    ...
    description: 'App shell where the left nav can collapse to icons for focus or smaller screens.',
    tier: 'modern',
    route: '/layouts/collapsible-sidebar',
    useCases: ['Space-constrained interfaces', 'Focus modes', 'Responsive design'],
    headerPattern: 'app-only',
    features: ['Collapsible navigation', 'Icon-only mode', 'Space optimization'],
  },
  {
    id: 'tabbed-content',
    name: 'Tabbed Content Layout',
    description: 'Horizontal tabs used to switch between related views within the same entity.',
    tier: 'modern',
    route: '/layouts/tabbed-content',
    useCases: ['Entity detail pages', 'Settings pages', 'Multi-view interfaces'],
    headerPattern: 'app-page',
  ...
  },
  {
    ...
    description: 'Two or more resizable panes allowing users to control how space is allocated.',
    tier: 'modern',
  ...
  },
  {
    ...
    description: 'Dense, data-heavy grid as the primary focus with filters and actions nearby.',
    tier: 'modern',
  ...
  },
  {
    ...
    description: 'Global or page-level search as the primary entry point into content.',
    tier: 'modern',
  ...
  // Top 15 (Advanced/Specialized) - Adds 5 more
  {
    ...
    description: 'Contextual details or settings shown in a toggleable right sidebar.',
    tier: 'advanced',
    route: '/layouts/right-inspector',
    useCases: ['Design tools', 'Property panels', 'Contextual help'],
    headerPattern: 'app-only',
    features: ['Toggleable right rail', 'Contextual information', 'Space adaptation'],
  },
  {
    id: 'command-centered',
    name: 'Command-Centered Layout',
    description: 'Minimal UI relying on command palettes or keyboard-first interactions.',
    tier: 'advanced',
    route: '/layouts/command-centered',
    useCases: ['Developer tools', 'Power user interfaces', 'Keyboard-first apps'],
    headerPattern: 'none',
  ...
  },
  {
    ...
    description: 'Distraction-free layout that hides navigation for editing or reviewing.',
    tier: 'advanced',
  ...
  },
  {
    ...
    description: 'Column-based layout optimized for drag-and-drop workflow management.',
    tier: 'advanced',
 ...
 * Get layouts by tier
 */
export function getLayoutsByTier(tier: LayoutMetadata['tier']): LayoutMetadata[] {
